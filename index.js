...
class Airplane {
 ...
 class Lambdasian {
    ...
    speak(){
      return `Hello my name is ${this.name}, I am from ${this.location}`; //returns string with users parameters
    }
  }
 ...
 class Instructor extends Lambdasian{
  constructor(attributes){
    super(attributes);//take parent (Lambdasian) and give Instructor its attributes
    this.specialty = attributes.specialty;
    this.favLanguage = attributes.favLanguage;
    this.catchPhrase = attributes.catchPhrase;
  }
  demo(subject){
    return `Today we are learning about ${subject}`; //returns string of given subject
  }
 ...
 class Student extends Lambdasian {
   constructor(attributes){
     ...
     listSubjects(){
      return `Loving ${this.favSubjects}!`;//returns array of students favorite subjects
    }
    PRAssignment(subject){
      return `${this.name} has submitted a PR for ${subject}`;//returns students name and given subject
    }
    sprintChallenge(subject){
      return `${this.name} has begun sprint challenge on ${subject}`;//returns students name and given subject
    }
     }
